...
import { ParticleModelProps, TWEEN_POINT } from '@/THREE/declare'
import VerticesDuplicateRemove from '@/utils/VerticesDuplicateRemove.js'
import BuiltinShaderAttributeName from '@/THREE/BuiltinShaderAttributeName'
...
class ParticleSystem {
  ...
  constructor(options: ParticleSystemProps) {
    ...
    // this.orbitControls.maxAzimuthAngle = Math.PI/2;;  // 水平角度
    // this.orbitControls.minAzimuthAngle = -Math.PI/2;
    this.orbitControls.enablePan = false; //禁止右键拖拽
    this.orbitControls.enableZoom = false; //禁止滚轮缩放
    this.orbitControls.enableRotate = false; //禁止左键旋转
